...
## 角色工作流
- 任何任务开始的第一步都是分析用户的需求，给出执行计划让用户确认, 用户确认计划后开始执行。如果用户在需求中明确表示跳过执行计划制定, 则可跳过这一步。
...
### 文件存放路径
- 所有设计相关的文件均存放于design/目录下
- 用户前端相关设计文件
    - 设计稿及线框图存放于 design/frontend-designs/wireframes/
    - HTML文件存放于 design/frontend-designs/html/
    - CSS文件存放于 design/frontend-designs/css/
    - Javascript文件存放于 design/frontend-designs/js/
- 管理后端相关设计文件
    - 设计稿及线框图存放于 design/backend-designs/wireframes/
    - HTML文件存放于 design/backend-designs/html/
    - CSS文件存放于 design/backend-designs/css/
    - Javascript文件存放于 design/backend-designs/js/
