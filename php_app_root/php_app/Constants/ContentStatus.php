...
enum ContentStatus: int
{
    case HIDDEN = 9;           // 隐藏
    case DRAFT = 11;            // 草稿
    case CREATIVE_0 = 31;        // 创意_0
    case CREATIVE_START = 35;        // 创意开始
    case CREATIVE_DONE = 39;        // 创意完成
    ...
    public function label(): string
    {
        return match($this) {
            ...
            self::DRAFT => '草稿',
            self::CREATIVE_0 => '创意0',
            self::CREATIVE_START => '创意开',
            self::CREATIVE_DONE => '创意完',
    ...
    public function englishLabel(): string
    {
        return match($this) {
            self::HIDDEN => 'Hidden',
            self::DRAFT => 'Draft',
            self::CREATIVE_0 => 'Creative 0',
            self::CREATIVE_START => 'Creative Start',
            self::CREATIVE_DONE => 'Creative Done',
    ...
    public function statusClass(): string
    {
        return match($this) {
            ...
            self::CREATIVE_0 => 'status-creative-0',
            self::CREATIVE_START => 'status-creative-start',
            self::CREATIVE_DONE => 'status-creative-done',
    ...
    public function bootstrapBadgeClass(): string
    {
        return match($this) {
            ...
            self::CREATIVE_0 => 'text-bg-secondary',        // 创意0 - 浅灰色
            self::CREATIVE_START => 'text-bg-warning',        // 创意开始 - 浅灰色
            self::CREATIVE_DONE => 'text-bg-info',        // 创意完成 - 浅灰色
            self::SCRIPT_START => 'text-bg-warning',     // 脚本开 - 蓝色(信息)
            self::SCRIPT_DONE => 'text-bg-info',   // 脚本完 - 主色(蓝色)
            self::SHOOTING_START => 'text-bg-warning', // 开拍 - 黄色(警告)
            self::SHOOTING_DONE => 'text-bg-info',  // 拍完 - 黄色(警告)
    ...
    public function icon(): string
    {
        return match($this) {
            ...
            self::CREATIVE_0 => 'bi-lightbulb',
            self::CREATIVE_START => 'bi-lightbulb',
            self::CREATIVE_DONE => 'bi-lightbulb',
    ...
    public static function getAllValues(): array
    {
        return [
            ...
            self::CREATIVE_0->value => self::CREATIVE_0->label(),
            self::CREATIVE_START->value => self::CREATIVE_START->label(),
            self::CREATIVE_DONE->value => self::CREATIVE_DONE->label(),
