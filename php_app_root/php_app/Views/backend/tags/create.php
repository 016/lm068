    ...
    <div class="row justify-content-center">
        <div class="col-12 col-lg-12">
            <div class="form-container">
                ...
                <div class="form-body">
                    <form id="tagCreateForm" action="/tags" method="POST">
                            ...
                            <div class="row">
                                <div class="col-md-6 pb-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="name_cn" name="name_cn" required>
                            ...
                            <div class="row">
                                <div class="col-md-6 pb-3">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="color_class" name="color_class">
                                            <option value="btn-outline-primary" selected>Primary (蓝色)</option>
                                            <option value="btn-outline-secondary">Secondary (灰色)</option>
                                            <option value="btn-outline-success">Success (绿色)</option>
                                            <option value="btn-outline-danger">Danger (红色)</option>
                                            <option value="btn-outline-warning">Warning (黄色)</option>
                                            <option value="btn-outline-info">Info (青色)</option>
                                            <option value="btn-outline-light">Light (浅色)</option>
                                            <option value="btn-outline-dark">Dark (深色)</option>
                                        </select>
                                ...
                                <div class="col-md-6 pb-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="icon_class" name="icon_class" value="bi-star" placeholder="请输入 Bootstrap 图标类名，如 bi-star">
                        ...
                        <div class="form-section">
                            ...
                            <div class="row">
                                <div class="col-md-6 pb-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="short_desc_cn" name="short_desc_cn" maxlength="100">
                                ...
                                <div class="col-md-6 pb-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="short_desc_en" name="short_desc_en" maxlength="100">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="desc_cn" name="desc_cn" rows="3" placeholder="请输入标签的详细中文描述..." maxlength="500"></textarea>
                                <div class="form-text">标签的详细中文说明（最多500字符）</div>
                            </div>

                            <div class="form-group">
                                <label for="desc_en" class="form-label">英文描述</label>
                                <textarea class="form-control" id="desc_en" name="desc_en" rows="3" placeholder="Please enter the detailed English description of the tag..." maxlength="500"></textarea>
                                    ...
                                    <div class="form-group">
                                        <div class="switch-group" id="statusSwitchGroup">
                                            <div class="custom-switch tag-edit-switch" id="statusSwitch">
                                                <input type="checkbox" id="status_id" name="status_id" value="1" checked>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // 表单提交处理
    document.getElementById('tagCreateForm').addEventListener('submit', handleFormSubmit);
...
function previewTag() {
    // 预览标签效果
    const formData = new FormData(document.getElementById('tagCreateForm'));
