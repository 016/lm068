...
-- 2. 插入标签数据 (20条)
-- ------------------------------------------------------------------
INSERT INTO `tag` (`id`, `name_en`, `name_cn`, `color_class`, `icon_class`, `content_cnt`) VALUES
(1, 'Python', 'Python', 'btn-outline-primary', 'bi-book', 4),
(2, 'JavaScript', 'JavaScript', 'btn-outline-primary', 'bi-book', 1),
(3, 'Go', 'Go语言', 'btn-outline-primary', 'bi-book', 3),
(4, 'AI', '人工智能', 'btn-outline-primary', 'bi-book', 3),
(5, 'Machine Learning', '机器学习', 'btn-outline-primary', 'bi-book', 2),
(6, 'Web Development', 'Web开发', 'btn-outline-primary', 'bi-book', 5),
(7, 'DevOps', 'DevOps', 'btn-outline-primary', 'bi-book', 4),
(8, 'Cloud Computing', '云计算', 'btn-outline-primary', 'bi-book', 1),
(9, 'Cybersecurity', '网络安全', 'btn-outline-primary', 'bi-book', 3),
(10, 'React', 'React框架', 'btn-outline-primary', 'bi-book', 2),
(11, 'Vue', 'Vue框架', 'btn-outline-primary', 'bi-book', 2),
(12, 'Database', '数据库', 'btn-outline-primary', 'bi-book', 1),
(13, 'Hardware Review', '硬件评测', 'btn-outline-primary', 'bi-book', 2),
(14, 'Tutorial', '入门教程', 'btn-outline-primary', 'bi-book', 6),
(15, 'Project Demo', '项目实战', 'btn-outline-primary', 'bi-book', 7),
(16, 'Tech News', '科技新闻', 'btn-outline-primary', 'bi-book', 4),
(17, 'Career', '职业发展', 'btn-outline-primary', 'bi-book', 3),
(18, 'Docker', 'Docker', 'btn-outline-primary', 'bi-book', 2),
(19, 'Kubernetes', 'Kubernetes', 'btn-outline-primary', 'bi-book', 2),
(20, 'Rust', 'Rust语言', 'btn-outline-primary', 'bi-book', 1);


-- 3. 插入合集数据 (10条)
-- ------------------------------------------------------------------
INSERT INTO `collection` (`id`, `name_en`, `name_cn`, `short_desc_cn`, `color_class`, `icon_class`, `content_cnt`) VALUES
(1, 'Python from Zero to Hero', 'Python入门到精通', '一个完整的Python学习路径系列', 'btn-outline-primary', 'bi-book', 4),
(2, 'Full-Stack with React & Node', 'React全栈开发实战', '使用React和Node.js构建现代化应用', 'btn-outline-primary', 'bi-book', 3),
(3, 'AI Frontier Insights', 'AI前沿观察', '追踪人工智能领域的最新突破和趋势', 'btn-outline-primary', 'bi-book', 2),
(4, 'DevOps Best Practices', 'DevOps最佳实践', '涵盖CI/CD、监控、自动化等核心实践', 'btn-outline-primary', 'bi-book', 4),
(5, 'Hardware Unboxing & Reviews', '硬件评测系列', '最新最热的科技产品开箱与深度评测', 'btn-outline-primary', 'bi-book', 2),
(6, 'Cybersecurity Fundamentals', '网络安全基础', '为初学者介绍网络安全的核心概念和技术', 'btn-outline-primary', 'bi-book', 2),
(7, 'Go Concurrency Programming', 'Go语言并发编程', '深入探索Go语言强大的并发模型', 'btn-outline-primary', 'bi-book', 3),
(8, 'Deep Dive into Vue.js 3', 'Vue.js 3 深度解析', '全面解析Vue 3的新特性和内部原理', 'btn-outline-primary', 'bi-book', 2),
(9, 'Weekly Tech Roundup', '每周科技快讯', '每周五更新，总结本周科技界的大事件', 'btn-outline-primary', 'bi-book', 2),
(10, 'Algorithms & Data Structures', '算法与数据结构', '用动画和实例生动讲解核心算法', 'btn-outline-primary', 'bi-book', 2);
...
-- Content ID: 6
(6, 1, 'https://www.youtube.com/watch?v=FX-dOauUjdA', 'FX-dOauUjdA_6', 25000, 2200, 800, 150),
(6, 2, 'https://www.bilibili.com/video/BV1HGn3ziEXg', 'BV1HGn3ziEXg_6', 28000, 4000, 5500, 300),
(6, 3, 'https://v.douyin.com/_TINkOOnOrg', '_TINkOOnOrg_6', 150000, 8000, 0, 450),
-- Content ID: 7
(7, 1, 'https://www.youtube.com/watch?v=FX-dOauUjdA', 'FX-dOauUjdA_7', 38000, 3500, 1200, 200),
(7, 2, 'https://www.bilibili.com/video/BV1HGn3ziEXg', 'BV1HGn3ziEXg_7', 40000, 6000, 7000, 400),
(7, 3, 'https://v.douyin.com/_TINkOOnOrg', '_TINkOOnOrg_7', 200000, 12000, 0, 600),
-- Content ID: 8
(8, 1, 'https://www.youtube.com/watch?v=FX-dOauUjdA', 'FX-dOauUjdA_8', 90000, 8000, 3000, 500),
(8, 2, 'https://www.bilibili.com/video/BV1HGn3ziEXg', 'BV1HGn3ziEXg_8', 60000, 10000, 12000, 800),
(8, 3, 'https://v.douyin.com/_TINkOOnOrg', '_TINkOOnOrg_8', 450000, 25000, 0, 1200),
-- ... 为简洁，此处省略了 content_id 9-28 的数据，您可以按此模式填充
-- 简单填充剩余部分
(9, 1, 'https://www.youtube.com/watch?v=FX-dOauUjdA', 'FX-dOauUjdA_9', 20000, 1800, 700, 100),
(9, 2, 'https://www.bilibili.com/video/BV1HGn3ziEXg', 'BV1HGn3ziEXg_9', 22000, 3500, 4000, 250),
(9, 3, 'https://v.douyin.com/_TINkOOnOrg', '_TINkOOnOrg_9', 100000, 5000, 0, 300),
(10, 1, 'https://www.youtube.com/watch?v=FX-dOauUjdA', 'FX-dOauUjdA_10', 50000, 4500, 2000, 400),
(10, 2, 'https://www.bilibili.com/video/BV1HGn3ziEXg', 'BV1HGn3ziEXg_10', 45000, 7000, 8000, 600),
(10, 3, 'https://v.douyin.com/_TINkOOnOrg', '_TINkOOnOrg_10', 300000, 15000, 0, 900),
(11, 1, 'https://www.youtube.com/watch?v=FX-dOauUjdA', 'FX-dOauUjdA_11', 30000, 2800, 1100, 180),
(11, 2, 'https://www.bilibili.com/video/BV1HGn3ziEXg', 'BV1HGn3ziEXg_11', 31000, 5000, 6000, 350),
(11, 3, 'https://v.douyin.com/_TINkOOnOrg', '_TINkOOnOrg_11', 180000, 9000, 0, 500),
(12, 1, 'https://www.youtube.com/watch?v=FX-dOauUjdA', 'FX-dOauUjdA_12', 18000, 1500, 600, 90),
(12, 2, 'https://www.bilibili.com/video/BV1HGn3ziEXg', 'BV1HGn3ziEXg_12', 20000, 3000, 3500, 200),
(12, 3, 'https://v.douyin.com/_TINkOOnOrg', '_TINkOOnOrg_12', 90000, 4000, 0, 250),
(13, 1, 'https://www.youtube.com/watch?v=FX-dOauUjdA', 'FX-dOauUjdA_13', 15000, 1300, 500, 80),
(13, 2, 'https://www.bilibili.com/video/BV1HGn3ziEXg', 'BV1HGn3ziEXg_13', 16000, 2500, 3000, 180),
(13, 3, 'https://v.douyin.com/_TINkOOnOrg', '_TINkOOnOrg_13', 80000, 3500, 0, 220),
(14, 1, 'https://www.youtube.com/watch?v=FX-dOauUjdA', 'FX-dOauUjdA_14', 12000, 1000, 400, 70),
(14, 2, 'https://www.bilibili.com/video/BV1HGn3ziEXg', 'BV1HGn3ziEXg_14', 13000, 2000, 2500, 150),
(14, 3, 'https://v.douyin.com/_TINkOOnOrg', '_TINkOOnOrg_14', 70000, 3000, 0, 200),
(15, 1, 'https://www.youtube.com/watch?v=FX-dOauUjdA', 'FX-dOauUjdA_15', 40000, 3800, 1500, 250),
(15, 2, 'https://www.bilibili.com/video/BV1HGn3ziEXg', 'BV1HGn3ziEXg_15', 48000, 6500, 7500, 450),
(15, 3, 'https://v.douyin.com/_TINkOOnOrg', '_TINkOOnOrg_15', 250000, 13000, 0, 700),
(16, 1, 'https://www.youtube.com/watch?v=FX-dOauUjdA', 'FX-dOauUjdA_16', 60000, 5500, 2500, 450),
(16, 2, 'https://www.bilibili.com/video/BV1HGn3ziEXg', 'BV1HGn3ziEXg_16', 60000, 8000, 9000, 650),
(16, 3, 'https://v.douyin.com/_TINkOOnOrg', '_TINkOOnOrg_16', 350000, 18000, 0, 1000),
(17, 1, 'https://www.youtube.com/watch?v=FX-dOauUjdA', 'FX-dOauUjdA_17', 45000, 4000, 1800, 350),
(17, 2, 'https://www.bilibili.com/video/BV1HGn3ziEXg', 'BV1HGn3ziEXg_17', 45000, 6000, 7000, 550),
(17, 3, 'https://v.douyin.com/_TINkOOnOrg', '_TINkOOnOrg_17', 280000, 14000, 0, 800),
(18, 1, 'https://www.youtube.com/watch?v=FX-dOauUjdA', 'FX-dOauUjdA_18', 22000, 2000, 900, 160),
(18, 2, 'https://www.bilibili.com/video/BV1HGn3ziEXg', 'BV1HGn3ziEXg_18', 23000, 3800, 4500, 280),
(18, 3, 'https://v.douyin.com/_TINkOOnOrg', '_TINkOOnOrg_18', 120000, 6000, 0, 350),
(19, 1, 'https://www.youtube.com/watch?v=FX-dOauUjdA', 'FX-dOauUjdA_19', 25000, 2300, 1000, 170),
(19, 2, 'https://www.bilibili.com/video/BV1HGn3ziEXg', 'BV1HGn3ziEXg_19', 26000, 4200, 5000, 300),
(19, 3, 'https://v.douyin.com/_TINkOOnOrg', '_TINkOOnOrg_19', 140000, 7000, 0, 400),
(20, 1, 'https://www.youtube.com/watch?v=FX-dOauUjdA', 'FX-dOauUjdA_20', 17000, 1600, 700, 110),
(20, 2, 'https://www.bilibili.com/video/BV1HGn3ziEXg', 'BV1HGn3ziEXg_20', 19000, 3000, 3500, 220),
(20, 3, 'https://v.douyin.com/_TINkOOnOrg', '_TINkOOnOrg_20', 100000, 5000, 0, 300),
(21, 1, 'https://www.youtube.com/watch?v=FX-dOauUjdA', 'FX-dOauUjdA_21', 35000, 3200, 1300, 220),
(21, 2, 'https://www.bilibili.com/video/BV1HGn3ziEXg', 'BV1HGn3ziEXg_21', 37000, 5500, 6500, 400),
(21, 3, 'https://v.douyin.com/_TINkOOnOrg', '_TINkOOnOrg_21', 200000, 10000, 0, 550),
(22, 1, 'https://www.youtube.com/watch?v=FX-dOauUjdA', 'FX-dOauUjdA_22', 14000, 1200, 500, 90),
(22, 2, 'https://www.bilibili.com/video/BV1HGn3ziEXg', 'BV1HGn3ziEXg_22', 15000, 2500, 3000, 180),
(22, 3, 'https://v.douyin.com/_TINkOOnOrg', '_TINkOOnOrg_22', 80000, 4000, 0, 250),
(23, 1, 'https://www.youtube.com/watch?v=FX-dOauUjdA', 'FX-dOauUjdA_23', 55000, 5000, 2200, 450),
(23, 2, 'https://www.bilibili.com/video/BV1HGn3ziEXg', 'BV1HGn3ziEXg_23', 55000, 7500, 8500, 650),
(23, 3, 'https://v.douyin.com/_TINkOOnOrg', '_TINkOOnOrg_23', 320000, 16000, 0, 1000),
(24, 1, 'https://www.youtube.com/watch?v=FX-dOauUjdA', 'FX-dOauUjdA_24', 9000, 800, 300, 60),
(24, 2, 'https://www.bilibili.com/video/BV1HGn3ziEXg', 'BV1HGn3ziEXg_24', 9000, 1500, 2000, 120),
(24, 3, 'https://v.douyin.com/_TINkOOnOrg', '_TINkOOnOrg_24', 50000, 2500, 0, 150),
(25, 1, 'https://www.youtube.com/watch?v=FX-dOauUjdA', 'FX-dOauUjdA_25', 48000, 4500, 1900, 300),
(25, 2, 'https://www.bilibili.com/video/BV1HGn3ziEXg', 'BV1HGn3ziEXg_25', 50000, 7000, 8000, 500),
(25, 3, 'https://v.douyin.com/_TINkOOnOrg', '_TINkOOnOrg_25', 280000, 14000, 0, 800),
(26, 1, 'https://www.youtube.com/watch?v=FX-dOauUjdA', 'FX-dOauUjdA_26', 16000, 1400, 600, 100),
(26, 2, 'https://www.bilibili.com/video/BV1HGn3ziEXg', 'BV1HGn3ziEXg_26', 17000, 2800, 3200, 200),
(26, 3, 'https://v.douyin.com/_TINkOOnOrg', '_TINkOOnOrg_26', 90000, 4500, 0, 280),
(27, 1, 'https://www.youtube.com/watch?v=FX-dOauUjdA', 'FX-dOauUjdA_27', 32000, 3000, 1200, 200),
(27, 2, 'https://www.bilibili.com/video/BV1HGn3ziEXg', 'BV1HGn3ziEXg_27', 33000, 5000, 6000, 380),
(27, 3, 'https://v.douyin.com/_TINkOOnOrg', '_TINkOOnOrg_27', 180000, 9000, 0, 500),
(28, 1, 'https://www.youtube.com/watch?v=FX-dOauUjdA', 'FX-dOauUjdA_28', 10000, 900, 400, 80),
(28, 2, 'https://www.bilibili.com/video/BV1HGn3ziEXg', 'BV1HGn3ziEXg_28', 12000, 2000, 2500, 150),
(28, 3, 'https://v.douyin.com/_TINkOOnOrg', '_TINkOOnOrg_28', 60000, 3000, 0, 180),
(29, 1, 'https://www.youtube.com/watch?v=FX-dOauUjdA', 'FX-dOauUjdA_29', 23000, 2100, 900, 160),
(29, 2, 'https://www.bilibili.com/video/BV1HGn3ziEXg', 'BV1HGn3ziEXg_29', 25000, 4000, 4800, 280),
(29, 3, 'https://v.douyin.com/_TINkOOnOrg', '_TINkOOnOrg_29', 130000, 6500, 0, 380);
