...
VALUES (1, 'tech_guru', 'tech_guru@example.com', '$2y$10$dummyhash.placeholder1', 'https://picsum.photos/150/150?random=1',
        '技术大师', 1),
       (2, 'code_master', 'code_master@example.com', '$2y$10$dummyhash.placeholder2',
        'https://picsum.photos/150/150?random=2', '编程高手', 1),
       (3, 'dev_jane', 'dev_jane@example.com', '$2y$10$dummyhash.placeholder3', 'https://picsum.photos/150/150?random=3',
        '开发者小简', 1),
       (4, 'sysadmin_joe', 'sysadmin_joe@example.com', '$2y$10$dummyhash.placeholder4',
        'https://picsum.photos/150/150?random=4', '运维小乔', 1),
       (5, 'data_nerd', 'data_nerd@example.com', '$2y$10$dummyhash.placeholder5', 'https://picsum.photos/150/150?random=5',
        '数据迷', 1),
       (6, 'cloud_expert', 'cloud_expert@example.com', '$2y$10$dummyhash.placeholder6',
        'https://picsum.photos/150/150?random=6', '云专家', 1),
       (7, 'security_sam', 'security_sam@example.com', '$2y$10$dummyhash.placeholder7',
        'https://picsum.photos/150/150?random=7', '安全员山姆', 1),
       (8, 'frontend_fay', 'frontend_fay@example.com', '$2y$10$dummyhash.placeholder8',
        'https://picsum.photos/150/150?random=8', '前端菲菲', 1),
       (9, 'backend_bob', 'backend_bob@example.com', '$2y$10$dummyhash.placeholder9',
        'https://picsum.photos/150/150?random=9', '后端鲍勃', 1),
       (10, 'mobile_mike', 'mobile_mike@example.com', '$2y$10$dummyhash.placeholder10',
        'https://picsum.photos/150/150?random=10', '移动麦克', 1),
       (11, 'ai_adele', 'ai_adele@example.com', '$2y$10$dummyhash.placeholder11', 'https://picsum.photos/150/150?random=11',
        '智能阿黛尔', 1),
       (12, 'game_gary', 'game_gary@example.com', '$2y$10$dummyhash.placeholder12',
        'https://picsum.photos/150/150?random=12', '游戏加里', 1),
       (13, 'db_diana', 'db_diana@example.com', '$2y$10$dummyhash.placeholder13', 'https://picsum.photos/150/150?random=13',
        '数据库黛娜', 1),
       (14, 'ux_ursula', 'ux_ursula@example.com', '$2y$10$dummyhash.placeholder14',
        'https://picsum.photos/150/150?random=14', '体验设计师苏拉', 1),
       (15, 'pm_pete', 'pm_pete@example.com', '$2y$10$dummyhash.placeholder15', 'https://picsum.photos/150/150?random=15',
        '产品经理皮特', 1),
       (16, 'qa_quincy', 'qa_quincy@example.com', '$2y$10$dummyhash.placeholder16',
        'https://picsum.photos/150/150?random=16', '测试昆西', 1),
       (17, 'devops_dave', 'devops_dave@example.com', '$2y$10$dummyhash.placeholder17',
        'https://picsum.photos/150/150?random=17', '运维开发戴夫', 1),
       (18, 'iot_ida', 'iot_ida@example.com', '$2y$10$dummyhash.placeholder18', 'https://picsum.photos/150/150?random=18',
        '物联网艾达', 1),
       (19, 'block_brian', 'block_brian@example.com', '$2y$10$dummyhash.placeholder19',
        'https://picsum.photos/150/150?random=19', '区块链布莱恩', 1),
       (20, 'quantum_quinn', 'quantum_quinn@example.com', '$2y$10$dummyhash.placeholder20',
        'https://picsum.photos/150/150?random=20', '量子计算奎恩', 1);
